...
describe('ai link suggestions', () => {
  ...
  it('ranks orphan link candidates by structure signals and reports friendly progress updates', async () => {
                    ...
                    suggestions: [
                      {
                        ...
                        confidence: 'high',
                        reason: '主题命中明确，补链后更容易回到 AI 主题网络。',
    ...
    expect(JSON.parse(requests[0]?.body.messages[1].content)).toEqual(expect.objectContaining({
      availableThemes: [
  ...
  it('returns AI suggestions based on structure signals', async () => {
                    ...
                    suggestions: [
                      {
                        ...
                        targetType: 'theme-document',
                        confidence: 'medium',
                        reason: '主题命中和结构角色都很明确，先补到主题页能更快回到现有网络。',
                      },
                    ],
                  }),
                },
