...
describe('WikiMaintainPanel', () => {
  ...
  it('renders scope summary, preview rows and apply shortcuts', async () => {
    ...
    expect(html).toContain('Tech topic')
    expect(html).toContain('Social topic')
    expect(html).toContain('HIGH')
    expect(html).toContain('MEDIUM')
    expect(html).toContain('Topic overview, Core principles, Relationship evidence')
    expect(html).toContain('Comparison')
    expect(html).toContain('Topic overview, Highlights, Core principles, Relationship evidence')
    expect(html).toContain('Introduction, Comparison, Sources')
    expect(html).toContain('Existing')
    expect(html).toContain('Created on first write')
